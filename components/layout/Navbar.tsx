...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full bg-background/90 backdrop-blur-sm border-b border-border z-50 transition-colors">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              <Link href="/" className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-4">
              {isAuthenticated ? (
                <>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <motion.button
                      ...
                      className="p-2 bg-secondary hover:bg-secondary/80 text-secondary-foreground rounded-lg transition"
                      title="Disconnect"
                    >
                ...
                <motion.button
                  ...
                  className="px-5 py-2 bg-card hover:bg-accent text-foreground border border-border rounded-lg transition font-semibold flex items-center gap-2"
                >
